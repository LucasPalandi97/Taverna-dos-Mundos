	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbarhome-collapse" id="ftco-navhome">
	        <ul class="navbarhome-navhome ml-auto">
                        ...
                        <li class="navhome-item active"><a href="contato.jsp" class="navhome-link"style='font-size:22px;'>Contato</a></li>
            ...
            <div class="container">
                <div class="row d-md-flex justify-content-end">
                    <div class="col-md-6 half p-3 py-5 pl-md-5 ftco-animate heading-section heading-section-white">
                        <span class="subheading">Mande seu Feed-back</span>
                        ...
                        <form action="#" class="consultation">
                            ...
                            <div class="form-group">
                                <input type="submit" value="Enviar Mensagem" class="btn btn-dark py-3 px-4">
                            </div>
                        </form>
                    </div>
                </div>
