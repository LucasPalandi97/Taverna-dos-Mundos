	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbarhome-collapse" id="ftco-navhome">
	        <ul class="navbarhome-navhome ml-auto">
                        ...
                        <li class="navhome-item active"><a href="sobrenos.jsp" class="navhome-link"style='font-size:22px;'>História</a></li>
            ...
            <div class="container-fluid px-md-5">
                <div class="row justify-content-center mb-5 pb-3">
                    <div class="col-md-7 text-center heading-section ftco-animate">
                        <span class="subheading">Os Taverneiros</span>
                        <h2 class="mb-4">Taverneiros de Plantão</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-2-4 col-lgm-3 col-md-4 col-sm-6"style="background-image: url(/images/person_1.jpg)">
                        <div class="block-2 ftco-animate" >
                            <div class="flipper" style="background-image: url(/images/person_1.jpg)">
                                <div class="front" style="background-image: url(/images/person_1.jpg);">
                                    <div class="box">
                                        <h2>Bruno Cordon</h2>
                                        <p>Mestre, Ilustrador e Designer</p>
                                    </div>
                                </div>
                                <div class="back">
                                    <!-- back content -->
                                    ...
                                    <div class="author d-flex">
                                        ...
                                        <div class="name align-self-center ml-3">Bruno Cordon <span class="position">Ilustrador e Designer</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2-4 col-lgm-3 col-md-4 col-sm-6">
                        <div class="block-2 ftco-animate">
                            <div class="flipper">
                                ...
                                <div class="back">
                                    ...
                                    <div class="author d-flex">
                                        ...
                                        <div class="name align-self-center ml-3">Emerson Luiz<span class="position">Ilustrador e Designer</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flipper">
                                ...
                                <div class="back">
                                    ...
                                    <div class="author d-flex">
                                        ...
                                        <div class="name align-self-center ml-3">Felipe Jacomini<span class="position">Advogado</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="block-2 ftco-animate">
                            <div class="flipper">
                                <div class="front" style="background-image: url(/images/person_4.jpg);">
                                    <div class="box">
                                        <h2>Lucas Palandi</h2>
                                        <p>Programador e Criador de Conteúdo</p>
                                    </div>
                                </div>
                                <div class="back">
                                    <!-- back content -->
                                    ...
                                    <div class="author d-flex">
                                        ...
                                        <div class="name align-self-center ml-3">Lucas Palandi<span class="position">Engenheiro da computação</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="block-2 ftco-animate">
                            <div class="flipper">
                                <div class="front" style="background-image: url(/images/person_5.jpg);">
                                    <div class="box">
                                        <h2>Rodrigo Guedes</h2>
                                        <p>Mestre e Programador </p>
                                    </div>
                                </div>
                                <div class="back">
                                    <!-- back content -->
                                    ...
                                    <div class="author d-flex">
                                        ...
                                        <div class="name align-self-center ml-3">Rodrigo Guedes<span class="position">Engenheiro da computação</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
